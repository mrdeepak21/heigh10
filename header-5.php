...
<link href="<?php bloginfo('template_directory'); ?>/assets/css/main.min.css" rel="stylesheet" type="text/css">
 ...
 <!-- plausible -->
  ...
  window.JETBOOST_SITE_ID = "ckevh436mxnus0712qhtaxlro"; (function(d) { var s = d.createElement("script"); s.src = "https://cdn.jetboost.io/jetboost.js"; s.async = 1; d.getElementsByTagName("head")[0].appendChild(s); })(document); 
  </script><!-- swiper CSS -->
  <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/assets/css/swiper-bundle.min.css">
  <style>

  /* Glassmorphism bg */
  .studio-slide_indicator  {
...
<?php wp_body_open(); ?>
  ...
  <div class="w_loader">
    <div data-w-id="0d95e04d-5bcc-5124-5dfb-ed5275e3f967" style=
    "display:flex;-webkit-transform:translate3d(0, 0vh, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0vh, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0vh, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0vh, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
    class="c-loading">
      <div data-w-id="0d95e04d-5bcc-5124-5dfb-ed5275e3f968" style=
      "display:none" class="div-block-12"><img src=
      "<?php echo esc_url( wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) ); ?>"
      alt="letter i " class="c-logo-i"><img src=
      "<?php echo esc_url( wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) ); ?>"
      alt="letter o" class="c-logo-o"><img src=
      "<?php echo esc_url( wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) ); ?>"
      alt="vovi brand circle logo" class="c-logo-cir"></div>
    </div>
  </div><a data-w-id="982d57a5-0573-1f9b-aa6a-383a43b74d7a" href=
  "/" class="c-brand w-inline-block">
 <img src=
  "<?php echo esc_url( wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) ); ?>"
  width="65" alt="vovi brand circle logo" class=
  "c-brand__image"><img src=
  "<?php echo esc_url( wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) ); ?>"
  alt="letter o" class="c-brand--image__o"><img src=
  "<?php echo esc_url( wp_get_attachment_image_url( get_theme_mod( 'custom_logo' ), 'full' ) ); ?>"
      ...
      <div class="w-layout-grid c-menu--grid new">
        ...
        <div id="w-node-_7d0200cc-4c86-f377-2431-ce8f396a4d1e-396a4d06" class="c-footer__grid-cards menu">
          <div class="w-layout-grid c-hero__grid menu">
            <a href="#" class="c-footer__gird-item-2 upper open-intercom w-inline-block">
  ...
  <div class="nav-button">
    <div class="nav-button__wrapper">
      ...
      data-w-id="72cac717-388d-6301-32d8-20a95781120e"
      data-animation-type="lottie" data-src=
      "<?php bloginfo('template_directory'); ?>/assets/lottieflow-menu-nav.json"
      data-loop="0" data-direction="1" data-autoplay="0"
      data-renderer="svg" data-default-duration=
      "2.0208333333333335" data-duration="0"></div>
    </div>
  </div>